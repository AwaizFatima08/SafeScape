                      ...
                      ? const Center(
                          child: Padding(
                            ...
                            child: Text('No routines yet.\nA grown-up can add one in the grown-ups area.',
                                textAlign: TextAlign.center, style: TextStyle(fontSize: 18, color: SC.textDim)),
                          ),
                        )
                                ...
                                child: Material(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () => Navigator.of(context).push(
                                      MaterialPageRoute(builder: (_) => RoutinePlayerScreen(routineId: r.id)),
                                    ),
                                    child: Padding(
