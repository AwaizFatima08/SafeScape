...
class _WaitTimerScreenState extends ConsumerState<WaitTimerScreen> with SingleTickerProviderStateMixin {
  ...
  void _log() {
    ...
    if (secs < 10) return;
    _store.logSession(
      SensorySession(id: newId('sess'), childId: child.id, mode: 'wait_timer', start: start, durationSeconds: secs),
    );
    _started = null;
  }
                ...
                Padding(
                  ...
                  child: Row(
                    children: const [
                      ...
                      SizedBox(width: 12),
                      Expanded(
                        child: Text('Wait Timer', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                      ),
                      MuteButton(),
                    ],
                  ),
                                  ...
                                  if (_finished)
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Time for ${iconLabels[_thenIcon]!.toLowerCase()}!',
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(18),
                                      border: Border.all(
                                        color: _thenIcon == k ? SC.sand : SC.slate3,
                                        width: _thenIcon == k ? 3 : 2,
                                      ),
                                    ),
...
class _DiscPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
      ...
      2 * pi * remaining,
      true,
      Paint()..color = SC.sand.withValues(alpha: 0.55),
    );
    canvas.drawOval(
      rect.deflate(3),
      Paint()
